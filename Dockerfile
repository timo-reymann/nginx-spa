...
LABEL org.opencontainers.image.title="nginx-spa" \
      org.opencontainers.image.description="Docker container to host your single page application" \
      ...
      org.opencontainers.image.url="https://github.com/timo-reymann/nginx-spa" \
